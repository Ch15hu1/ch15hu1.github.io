...
本节将要创建一个项目，并且显示出一个窗口，窗口中有一段文字 "Hello ImGui"
## 1 - 创建项目
创建一个空项目就好了，然配置项目名称，等等。
![](https://ch15hu1.github.io/images/93CE35A7135C7F658E9B136053D2D8F0.png)

把这些文件复制过来
![](https://ch15hu1.github.io/images/B7FB56DEDDF51F682EC2B9D27E3F78DE.png)
![](https://ch15hu1.github.io/images/80785AB7A008F6F8338EFDDD06B7B8CF.png)
### 其他配置
包含 d3d11.lib dxgi.lib
![](https://ch15hu1.github.io/images/3BC418A7DCE5FE6ACAD695B0366DE099.png)

Subsystem: Windows
![](https://ch15hu1.github.io/images/D551129D97A597A0D0BA45740EEB7439.png)
## 2 - 创建窗口
这一份完整的，没有 imgui_demo 的代码
```cpp
...
CreateDeviceD3D(HWND hWnd)
{
  ...
  // backend does this automatically for secondary viewports that it creates.
...
### 1 - 只显示 ImGui 窗口
这个Win32窗口碍眼，给他隐藏掉
![](https://ch15hu1.github.io/images/167C1DA0A4B1F50AAC175B6ADE52F440.png)

修改一下这两配置
```cpp
  ::ShowWindow(hwnd, SW_HIDE); // 隐藏 Win32 窗口
   io.ConfigViewportsNoAutoMerge = true;
```
![](https://ch15hu1.github.io/images/CEC852F924CBAECC9A9CD749084CB5E4.png)
![](https://ch15hu1.github.io/images/EB5F5BA33145506EDC33B8EA83B6F2FF.png)
### 2 - 主题
切换到白色主题
![](https://ch15hu1.github.io/images/AFC44BD86FF7FA9963A2B9638E23B663.png)

选择主题的方式，就是针对每一个空间都有一个 RGBA 可以配置
![](https://ch15hu1.github.io/images/C1C4B39AA18D92DE20B42019CFA31442.png)

ImGui 其实有三套主题
![](https://ch15hu1.github.io/images/88718781D8D10E11E39460A6CFFA8DF1.png)
### 3 - 开始绘制
![](https://ch15hu1.github.io/images/A0AC66FC3D09CE4DFF97C2162C5D8BC3.png)

```cpp
ImGui_ImplDX11_NewFrame();  // 从 Windows 系统抓取当前的鼠标位置、键盘按键、窗口尺寸变化等输入消息。
ImGui_ImplWin32_NewFrame(); // 告诉 DX11 后端准备新的渲染资源（比如更新字体纹理）。
ImGui::NewFrame();          // 清空上一帧的绘制列表，准备开始记录这一帧的所有 UI 控件
```
